...
public class Customer1OrderService(ILogger<Customer1OrderService> logger, IOrderRepository orderRepository) : BaseOrderService(logger, orderRepository)
{
    private readonly ILogger<Customer1OrderService> _logger = logger;
