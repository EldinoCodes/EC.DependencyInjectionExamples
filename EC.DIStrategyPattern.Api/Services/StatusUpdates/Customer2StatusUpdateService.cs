...
public class Customer2StatusUpdateService(ILogger<Customer2StatusUpdateService> logger, IStatusUpdateRepository statusUpdateRepository) : BaseStatusUpdateService(logger, statusUpdateRepository)
{
    private readonly ILogger<Customer2StatusUpdateService> _logger = logger;
